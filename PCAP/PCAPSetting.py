...
class Setting:
    ...
    def add_item_to_layer_selection(self):
        ...
        self.widget.rtListOfLayers.addItems(obj_array + obj_botmask + obj_fixed_support + obj_stop_block + obj_pressfit)
        ...
        self.widget.ulListOfLayers.addItems(obj_array + obj_open + obj_fixed_support + obj_stop_block + obj_pressfit + obj_edge)
        ...
        self.widget.prefPCAPListOfLayers.addItems(obj_array + obj_fixed_support + obj_stop_block + obj_pressfit + obj_edge)
