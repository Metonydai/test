...
# Assign coil.
# Create Winding1 
winding1 = m3d.assign_winding(coil_terminals=None)
...
# Winding2
# Create Winding2
winding2 = m3d.assign_winding(coil_terminals=None)
...
for sh in sheet_list:
    ...
    coil = m3d.assign_coil(sh, conductor_number=winding_dict[prefix], polarity="Positive", name=f"CoilTerminal_{i}")
...
# Assign eddy_effect
m3d.eddy_effects_on(eddy_list, activate_eddy_effects=True, activate_displacement_current=True)
#%%
###############################################################################
# Create Core Gap
# ~~~~~~~~~~~~
...
setup_name = "MySetup"
setup = m3d.create_setup(setupname=setup_name)
#print(setup.props)
...
m3d.import_dataset1d(tab_ip1_path, dsname="Ip1", is_project_dataset=False)
m3d.import_dataset1d(tab_is1_path, dsname="Is1", is_project_dataset=False)
